      ...
      <div className="p-5">
        <div className="flex items-center">
          ...
          <div className="w-full ml-5 flex flex-col justify-between">
            <div className="">
              <p className="text-4xl font-semibold">{name.full}</p>
              <p className="text-2xl">{name.native}</p>
              <p className="text-accent-two drop-shadow-accent-two w-fit rounded-full">
                {role}
              </p>
            </div>
            ...
            {voiceActors.map((voiceActor, i) => {
              ...
              return (
                <div className="flex gap-x-2 items-center" key={i}>
                  ...
                  <div>
                    <p>{name.full}</p>
                    <p className="text-white/40 text-xs">{languageV2}</p>
                  </div>
                </div>
              );
            })}
